...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/icy-paper-9434
```

A live public deployment of this template is available at [https://icy-paper-9434.templates.workers.dev](https://icy-paper-9434.templates.workers.dev)
